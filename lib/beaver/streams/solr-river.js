...
SolrRiver.prototype.end = function(buffer,encoding){
	...
	if(this.queue === 0 && this.errors.length === 0) this.emit('end');
	if(this.queue === 0 && this.errors.length > 0) this.emit('error',this.errors[0]);
}
...
SolrRiver.prototype._onresponse = function(err,obj){
	...
	if(this._ended && this.queue === 0 && this.errors.length === 0) this.emit('end');
	if(this._ended && this.queue === 0 && this.errors.length > 0) this.emit('error',this.errors[0])
	if(this._destroyed && this.queue === 0) this.emit('close');
}
